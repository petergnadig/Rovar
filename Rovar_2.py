...
# Rovarhoz folytonos labmoszgato kod
# ToDo: Lab veg poziciokat meg hangolni kell
...
# sorszam, lent, +fent, +pihen, sorszam, elol, +hatul, +pihen
B1  = array ("h", [ 0, 330, +100, +150, 1, 450, -150, -250])
B2  = array ("h", [ 3, 350, +100, +150, 2, 450, -150, -250])
B3  = array ("h", [ 5, 350, +100, +150, 4, 570, -150, -250]) 
J1  = array ("h", [ 7, 470, -100, -150, 6, 360, +150, +230])  
J2  = array ("h", [ 9, 455, -100, -150, 8, 380, +150, +230]) 
J3  = array ("h", [11, 480, -100, -150,10, 230, +150, +230]) 

Sebesseg = 0.004

def megy(lepes):
    for q in range (1,lepes):
      for i in range (0,101):
        #Vizszintes mozgas hatra:
        xv=i/float(100)
        pwm.setPWM(B1[4], 0, B1[5]+ int(B1[6]*xv))
        pwm.setPWM(J2[4], 0, J2[5]+ int(J2[6]*xv))
        pwm.setPWM(B3[4], 0, B3[5]+ int(B3[6]*xv))
...
def LabLent():
    pwm.setPWM(B1[0], 0, B1[1])
    pwm.setPWM(B1[4], 0, B1[5])
    pwm.setPWM(B2[0], 0, B2[1])
    pwm.setPWM(B2[4], 0, B2[5])
    pwm.setPWM(B3[0], 0, B3[1])
    pwm.setPWM(B3[4], 0, B3[5])
    pwm.setPWM(J1[0], 0, J1[1])
    pwm.setPWM(J1[4], 0, J1[5])
    pwm.setPWM(J2[0], 0, J2[1])
    pwm.setPWM(J2[4], 0, J2[5])
    pwm.setPWM(J3[0], 0, J3[1])
    pwm.setPWM(J3[4], 0, J3[5])
